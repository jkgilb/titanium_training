...
/**
 The base class for all k01_01 modules
 */
...
/**
 k01_01 Platform calls this method on startup.
 */
-(void)startup;

/**
 k01_01 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k01_01 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k01_01 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k01_01 Platform calls this method on resume.
 @param sender The sender of the event.
 */
